...
\NormalTok{lowercase\_vector }\OtherTok{\textless{}{-}}\NormalTok{ letters}
\NormalTok{lowercase\_vector}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{uppercase\_matrix }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(LETTERS, }\AttributeTok{nrow =} \DecValTok{2}\NormalTok{, }\AttributeTok{byrow =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{uppercase\_matrix}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Part c}
\FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"The value of x is:"}\NormalTok{, x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"The value of y is:"}\NormalTok{, y))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "The value of y is: 12"
\end{verbatim}
